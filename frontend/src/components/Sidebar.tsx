    ...
    return (
        <div className="w-64 flex-shrink-0 flex flex-col pt-5 pb-4 bg-slate-50 border-r border-slate-200 h-full overflow-y-auto">
            ...
            <nav className="mt-2 flex-1 px-3 space-y-1">
                ...
                <button className="w-full text-slate-600 hover:bg-slate-100 group flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-colors">
                    <Clock className="text-slate-400 group-hover:text-slate-600 mr-3 flex-shrink-0 h-5 w-5" />
                    Recent
                </button>
                <button className="w-full text-slate-600 hover:bg-slate-100 group flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-colors">
                    <Star className="text-slate-400 group-hover:text-slate-600 mr-3 flex-shrink-0 h-5 w-5" />
                    Starred
                </button>
                <button
